    ...
    render() {
        ...
        return (
            <View style={styles.container}>
                ...
                />
                <View style={{ flexDirection: 'row', alignItems: 'center',marginHorizontal:16, marginTop: 10, marginBottom: 20 }}>
                        <Image source={require('../img/Que5.png')} resizeMode="stretch" style={{ height: 50, width: 120, marginRight: 30 }} />
                        <TouchableOpacity style={{ alignItems: 'center', marginRight: 20 }} onPress={()=>this.setState({pagina:'home'})}>
                            <IconMaterial name="home" size={35} color={this.state.pagina=='home'?"#7E5682":"#E1DADF"} />
                            <Text style={{ color: '#A4A4A4', fontSize: 10 }}>Home</Text>
                        </TouchableOpacity>
                        <TouchableOpacity style={{ alignItems: 'center', marginRight: 20 }} onPress={()=>this.setState({pagina:'friends'})}>
                ...
                {this.state.pagina == 'home' && <View style={styles.contenido}>
                    ...
                    <TouchableOpacity activeOpacity={0.7} style={{ padding: 10, borderRadius: 5, backgroundColor: '#7E5682', flexDirection: 'row', alignItems: 'center' }}>
                        ...
                        <View activeOpacity={0.6} style={{ paddingVertical: 10 }}>
                            <View style={{ flexDirection: 'row', alignItems: 'center' }}>
                                ...
                                <TouchableOpacity style={{ borderRadius: 5, backgroundColor: '#7E5682', alignItems: 'center' }}>
                                    <Text style={{ color: '#FFF',padding:5,fontSize:12 }}>Responder</Text>
                                </TouchableOpacity>
                            </View>
