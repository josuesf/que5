        ...
        return (
            <View style={styles.container}>
                ...
                {this.state.pagina == 'home' && <View style={styles.contenido}>
                    ...
                    <TouchableOpacity onPress={() => navigate('pregunta')} activeOpacity={0.7} 
                        style={{ paddingVertical: 5,paddingHorizontal:10, borderRadius: 5, backgroundColor: '#00A896', flexDirection: 'row', alignItems: 'center' }}>
                        <Text style={{ color: '#F0F3BD', flex: 1, fontWeight: 'bold' }}>Nueva pregunta?</Text>
                    ...
                    <View style={{ marginVertical: 20 }}>
                        <TouchableOpacity onPress={() => navigate('preguntas_con')}
                            ...
                            <View style={{ flexDirection: 'row', alignItems: 'center' }}>
                                ...
                                <Text style={{ flex: 1, color: '#028090' }}>@Juanita_perez</Text>
